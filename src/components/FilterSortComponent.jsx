...
const FilterSortComponent = () => {
  ...
  const [showBookingStatusOptions, setShowBookingStatusOptions] =
    useState(false);
  ...
  const handleBookingStatusDropdown = () => {
    setShowBookingStatusOptions(!showBookingStatusOptions);
  };

  const handlePaymentStatusDropdown = () => {
  ...
  return (
    <div className="mt-10 h-16 bg-[#F9F9FA] border border-[#C8C8C8] rounded-lg  flex justify-between items-stretch">
      <div className="flex items-stretch">
          ...
          {showCalendarOptions && (
            <div className="absolute top-full  bg-[#FFFFFF]  mt-2 p-2 rounded-md shadow-lg z-10">
              ...
              <div className="flex items-center mb-2">
                <label className="w-24 text-[#000000] text-sm font-normal">Start Date</label>
                <input
                  type=""
        ...
        <div className="flex items-center p-4 relative">
          <span
            onClick={handleBookingStatusDropdown}
            style={{ cursor: "pointer" }}
            className="text-[#202224] text-sm font-medium"
          >
            Booking Status
          ...
          <FontAwesomeIcon
            icon={showBookingStatusOptions ? faChevronUp : faChevronDown}
            className="text-[#222222]  ml-2 cursor-pointer"
            onClick={handleBookingStatusDropdown}
          />
          {showBookingStatusOptions && (
        ...
        <div className="flex items-center p-4 relative">
          <span
            onClick={handlePaymentStatusDropdown}
            style={{ cursor: "pointer" }}
            className="text-[#202224] text-sm font-medium"
          >
            Payment Status
          ...
          <FontAwesomeIcon
            icon={showPaymentStatusOptions ? faChevronUp : faChevronDown}
            className="text-[#222222]  ml-2 cursor-pointer"
            onClick={handlePaymentStatusDropdown}
          />
        ...
        <Divider />
        <div className="flex items-center p-4 relative">
          <span onClick={handleCreatedByDropdown} style={{ cursor: "pointer" }}
           className="text-[#202224] text-sm font-medium">
            Created By
          </span>
          <FontAwesomeIcon
            icon={showCreatedByOptions ? faChevronUp : faChevronDown}
            className="text-[#222222]  ml-2 cursor-pointer"
            onClick={handleCreatedByDropdown}
          />
          {showCreatedByOptions && (
            <div className="absolute top-full w-36 bg-[#FFFFFF]  mt-2 p-2 rounded-md z-10">
              <label className="flex items-center mb-4 mt-2">
                <input
                  type="radio"
